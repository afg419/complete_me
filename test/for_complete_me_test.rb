...
class ForCompleteMeTest < Minitest::Test

  attr_reader :complete

  def setup
    @complete = ForCompleteMe.new
  end

  def test_it_exists
    assert ForCompleteMe.new
  end
